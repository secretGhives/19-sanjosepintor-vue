  ...
  <article class="privacy privacy-policy content-wrapper">
    ...
    <section id="section--privacy-policy">
      <div class="main-content">
        ...
        <p>{{ company }} ("us", "we", or "our") operates the {{ url }} website (hereinafter referred to as the "Service").</p>
        ...
        <div class="grouped">
          ...
          <ul>
            <li>
              <p><strong>Service</strong> Service is the {{ url }} website operated by {{ company }}</p>
            </li>
            <li>
